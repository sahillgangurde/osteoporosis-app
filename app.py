...
def predict():
    ...
    try:
        ...
        explanation = "High risk profile detected. Clinical intervention and BMD testing recommended." if score > 50 else "Stable bone health profile. Maintain current lifestyle and nutrition."
...
def download_report():
    ...
    try:
        ...
        if isinstance(pdf_str, str):
            ...
            pdf_bytes = pdf_str
        return send_file(io.BytesIO(pdf_bytes), as_attachment=True, download_name=f'OsteoScan_Report.pdf', mimetype='application/pdf')
    except Exception as e:
